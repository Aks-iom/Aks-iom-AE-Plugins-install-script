...
public partial class TelemetryConsentDialog : Window
{
    ...
    private void BrowseAePath_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Description = L10n.T("tcd.ae_path.title"),
    ...
    private void AePathBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
    {
        if (AePathPlaceholder != null)
            AePathPlaceholder.Visibility = string.IsNullOrEmpty(AePathBox.Text)
                ? Visibility.Visible
