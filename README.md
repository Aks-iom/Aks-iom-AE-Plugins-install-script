...
<img src="splash.png" alt="Aksiom Installer" width="180"/>

# Aksiom AE Plugins Installer

**Автоматическая установка плагинов для Adobe After Effects в пару кликов**

[![Release](https://img.shields.io/github/v/release/Aks-iom/Aks-iom-AE-Plugins-install-script?label=версия&color=blueviolet)](https://github.com/Aks-iom/Aks-iom-AE-Plugins-install-script/releases)
[![License](https://img.shields.io/github/license/Aks-iom/Aks-iom-AE-Plugins-install-script?color=blue)](LICENSE)
[![Telegram](https://img.shields.io/badge/Telegram-канал-26A5E4?logo=telegram)](https://t.me/AE_plugins_script)
[![Windows](https://img.shields.io/badge/платформа-Windows-0078D4?logo=windows)](https://github.com/Aks-iom/Aks-iom-AE-Plugins-install-script/releases)
...
**Aksiom Installer** — это удобный графический инсталлятор, который автоматически скачивает и устанавливает популярные платные плагины для Adobe After Effects версий **2020–2026**.
